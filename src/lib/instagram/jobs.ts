import type { ScrapeJob, InstagramInsightResult } from "./types";
...
export function completeJob(id: string, result: InstagramInsightResult): void {
...
export function rateLimitJob(id: string): void {
  updateJob(id, { status: "rate_limited", error: "Instagram rate limit / challenge detected", completedAt: new Date().toISOString() });
}
